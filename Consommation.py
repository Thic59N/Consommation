...
def install_requirements():
    # On ne lance l'installation automatique QUE si on est en local
    # Streamlit Cloud définit une variable d'environnement "STREAMLIT_RUNTIME_EXECUTION_MODE"
...
# On tente l'installation uniquement si on n'est pas sur le Web
